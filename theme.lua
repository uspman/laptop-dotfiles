...
theme.tasklist_fg_focus                         = "#7197E7"
...
theme.weather = lain.widget.weather({
    city_id = 5308655, -- placeholder (Phoenix)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
           ...
           -- wibox.container.background(wibox.container.margin(wibox.widget { mailicon, mail and mail.widget, layout = wibox.layout.align.horizontal }, 4, 7), "#343434"),
            ...
            arrow("#5A5A5A", "#5A5A5A"),
            wibox.container.background(wibox.container.margin(wibox.widget { volicon, theme.volume.widget, layout = wibox.layout.align.horizontal }, 2, 3), "#5A5A5A"),
            arrow("#5A5A5A", "#7197E7"),
            ...
            arrow("#7197E7", "#5A5A5A"),
            wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, 3, 4), "#5A5A5A"),
            arrow("#5A5A5A", "#7197E7"),
            ...
            arrow("#7197E7", "#5A5A5A"),
            wibox.container.background(wibox.container.margin(wibox.widget { weathericon, theme.weather.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#5A5A5A"),
            arrow("#5A5A5A", "#7197E7"),
