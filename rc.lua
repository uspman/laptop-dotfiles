...
globalkeys = my_table.join(
    ...
    awful.key({ modkey,         }, "f", function () awful.spawn( "pcmanfm" ) end,
              {description = "Launch pcmanfm", group = "awesome"}),
    awful.key({ altkey,         }, "l", function () awful.spawn( "alacritty -e /usr/bin/xscreensaver-command lock" ) end,
              {description = "Launch pcmanfm", group = "awesome"}),
    awful.key({ modkey,         }, "v", function () awful.spawn( "alacritty -e ranger" ) end,
              {description = "Launch ranger", group = "awesome"}),
    awful.key({ modkey, "Shift" }, "r", awesome.restart,
              {description = "Reload awesome", group = "awesome"}),
    --awful.key({ modkey,         }, "e", function ()  awful.spawn( "emacs" ) end,
      --        {description = "Launch EMACS", group = "awesome"}),
      ...
      grabber =
        awful.keygrabber.run(
          function(_, key, event)
            ...
            if     key == "e" then awful.spawn.with_shell(emacs .. "--eval '(doom/window-maximize-buffer)'")
...
awful.spawn.with_shell("dwall -s earth")
